...
printf " ${FG_BLUE}${ICON_PL_LROUND}${BG_BLUE}${FG_CRUST} ~/robinhood/rh ${RST}${FG_BLUE}${ICON_PL_RROUND}${RST}"
...
printf "${FG_OVERLAY}  │  "
printf "  ${FG_SURFACE1}${ICON_PL_LROUND}${BG_SURFACE1}${FG_SUBTEXT} 14:32 ${RST}${FG_SURFACE1}${ICON_PL_RROUND}${RST}"
printf " ${FG_MAUVE}${ICON_PL_LROUND}${BG_MAUVE}${FG_CRUST} ${ICON_K8S} prod/payments ${FG_MAUVE}${BG_SURFACE1}${ICON_PL_RROUND}${BG_SURFACE1}${FG_SUBTEXT} rde-henry ${FG_SURFACE1}${BG_TEAL}${ICON_PL_RROUND}${BG_TEAL}${FG_CRUST} ${ICON_GEAR}2 ${RST}${FG_TEAL}${ICON_PL_RROUND}${RST}"
printf " ${FG_BLUE}${ICON_PL_LROUND}${BG_BLUE}${FG_CRUST} ~/robinhood/rh ${RST}${FG_BLUE}${ICON_PL_RROUND}${RST}"
